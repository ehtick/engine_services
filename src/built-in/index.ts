 ...
 *
 * **Recommended**: Call `client.setBuiltInGlobals({ OBC, OBF, BUI, CUI, THREE, FRAGS })` once,
 * then load components with `client.initBuiltInComponent(Component, components)` — globals are applied automatically.
 *
 * **Alternative**: Pass globals per component: `client.initBuiltInComponent(Component, components, globals)`.
 * The `globals` object must include the libraries the component depends on at runtime.
 *
 * | Component             | Required globals                              | Packages                                                                  |
 * |-----------------------|-----------------------------------------------|---------------------------------------------------------------------------|
 * | AppManager            | `{ OBC, BUI }`                                | `@thatopen/components`, `@thatopen/ui`                                    |
 * | ViewportManager       | `{ OBC, BUI, THREE, FRAGS }`                  | `@thatopen/components`, `@thatopen/ui`, `three`, `@thatopen/fragments`    |
 * | LoadModelButton       | `{ OBC, BUI }`                                | `@thatopen/components`, `@thatopen/ui`                                    |
 * | ModelsDropdown        | `{ OBC, BUI }`                                | `@thatopen/components`, `@thatopen/ui`                                    |
 * | ModelsPanel           | `{ OBC, BUI, CUI }`                           | `@thatopen/components`, `@thatopen/ui`, `@thatopen/ui-obc`               |
 * | ViewerToolbar         | `{ OBC, OBF, BUI, THREE }`                    | `@thatopen/components`, `@thatopen/components-front`, `@thatopen/ui`, `three` |
 * | ColorsPalette         | `{ OBC, OBF, BUI }`                           | `@thatopen/components`, `@thatopen/components-front`, `@thatopen/ui`      |
 * | ClashesList           | `{ OBC, OBF, BUI, THREE }`                    | `@thatopen/components`, `@thatopen/components-front`, `@thatopen/ui`, `three` |
 * | ClassificationsList   | `{ OBC, OBF, BUI }`                           | `@thatopen/components`, `@thatopen/components-front`, `@thatopen/ui`      |
 * | ClippingsList         | `{ OBC, BUI }`                                | `@thatopen/components`, `@thatopen/ui`                                    |
 * | HighlightersList      | `{ OBC, OBF, BUI }`                           | `@thatopen/components`, `@thatopen/components-front`, `@thatopen/ui`      |
 * | LengthMeasuringsList  | `{ OBC, OBF, BUI, THREE }`                    | `@thatopen/components`, `@thatopen/components-front`, `@thatopen/ui`, `three` |
 * | AreaMeasuringsList    | `{ OBC, OBF, BUI, THREE }`                    | `@thatopen/components`, `@thatopen/components-front`, `@thatopen/ui`, `three` |
 * | QtoComparisonList     | `{ OBC, OBF, BUI }`                           | `@thatopen/components`, `@thatopen/components-front`, `@thatopen/ui`      |
 * | QueriesHierarchy      | `{ OBC, OBF, BUI }`                           | `@thatopen/components`, `@thatopen/components-front`, `@thatopen/ui`      |
 * | CustomViewLegend      | `{ OBC, BUI }`                                | `@thatopen/components`, `@thatopen/ui`                                    |
 * | ScreenshotAnnotator   | `{ OBC, BUI, MARKERJS }`                      | `@thatopen/components`, `@thatopen/ui`, `@markerjs/markerjs3`            |
 *
 * ### Global abbreviations
 *
 * - `OBC`      = `import * as OBC from "@thatopen/components"`
 * - `OBF`      = `import * as OBF from "@thatopen/components-front"`
 * - `BUI`      = `import * as BUI from "@thatopen/ui"`
 * - `CUI`      = `import * as CUI from "@thatopen/ui-obc"`
 * - `THREE`    = `import * as THREE from "three"`
 * - `FRAGS`    = `import * as FRAGS from "@thatopen/fragments"`
 * - `MARKERJS` = `import * as MARKERJS from "@markerjs/markerjs3"`
 */
